            ...
            <li class="nav-item dropdown mx-1 btn-primary">
              <div class="d-flex flex-column">              
                ...
                <div class="dropdown-center">                
                  ...
                  <ul class="dropdown-menu">
                    <li><a class="dropdown-item" onclick="Cookies.remove('id',  {domain:'sql112.infinityfree.com', path: '/mainpage'});" href="../../index.php"><i class="fa-solid fa-power-off"></i>Log Out</a></li>                    
                  </ul>
                </div>
              </div>                            
            </li>
