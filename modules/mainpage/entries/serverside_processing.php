...
if(isset($_POST['extra_search'])){
    $extra_search = mysqli_escape_string($con,$_POST['extra_search']);
    $search_where = "schedule_fight LIKE '$extra_search'";

    echo json_encode(
        SSP::complex( $_GET, $sql_details, $table, $primaryKey, $columns,null, $search_where )
    );
}
else{
    echo json_encode(
